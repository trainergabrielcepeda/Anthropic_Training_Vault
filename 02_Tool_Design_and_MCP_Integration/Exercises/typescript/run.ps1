# Run all TypeScript exercises for Domain 2 — Tool Design & MCP Integration
Set-Location $PSScriptRoot

Write-Host "=== Domain 2: Tool Design & MCP Integration — TypeScript Exercises ===" -ForegroundColor Cyan
Write-Host ""
